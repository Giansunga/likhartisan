...
CREATE TABLE IF NOT EXISTS models_3d (
  ...
  base_height_in NUMERIC(5,2) CHECK (base_height_in > 0),
  base_body_width_in NUMERIC(5,2) CHECK (base_body_width_in > 0),
  base_neck_width_in NUMERIC(5,2) CHECK (base_neck_width_in > 0),
  base_rim_size_in NUMERIC(5,2) CHECK (base_rim_size_in > 0),

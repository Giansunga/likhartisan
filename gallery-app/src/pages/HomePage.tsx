...
const SAMPLE_REVIEWS: HomeReview[] = [
  ...
  { id: 'sample-5', userName: 'Liza Mendoza', rating: 5, body: 'The finish is beautiful and the vase arrived safely packed. It adds a warm handmade touch to our dining table.', productName: 'Terracotta Vase', createdAt: '' },
  { id: 'sample-6', userName: 'Ramon Villanueva', rating: 4, body: 'A thoughtful gift with real character. The clay texture and shape feel much more special than anything mass produced.', productName: 'Decorative Amphora', createdAt: '' },
  { id: 'sample-7', userName: 'Bea Cruz', rating: 5, body: 'I ordered a planter and was impressed by the care in every detail. It looks wonderful with our growing herbs.', productName: 'Garden Planter', createdAt: '' },
  { id: 'sample-8', userName: 'Marco Reyes', rating: 5, body: 'The shop was kind and responsive from start to finish. The piece feels sturdy, useful, and beautifully made.', productName: 'Clay Water Jar', createdAt: '' },
  { id: 'sample-9', userName: 'Elena Bautista', rating: 4, body: 'Such a lovely local find. The color is natural, the form is elegant, and it made our living room feel more personal.', productName: 'Tabletop Vessel', createdAt: '' },
  { id: 'sample-10', userName: 'Paolo Santos', rating: 5, body: 'Wonderful craftsmanship and a smooth ordering experience. I will be coming back to find another piece for our home.', productName: 'Tea Light Vase', createdAt: '' },
];
      ...
      <div className="home-container">
        <div className="home-editorial-intro__grid">
          ...
          <div className="home-editorial-intro__photos">
            <figure className="home-editorial-photo home-editorial-photo--lead"><img src="/images/hero_1.jpg" alt="Rows of finished clay pots in a Santo Tomas workshop" loading="lazy" /></figure>
            <figure className="home-editorial-photo home-editorial-photo--detail"><img src="/images/history_bottom_right.jpg" alt="A potter shaping a large clay vessel" loading="lazy" /></figure>
